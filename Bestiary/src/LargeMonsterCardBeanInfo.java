 ...
 * @author marthahamlin
 */
public class LargeMonsterCardBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( LargeMonsterCard.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", LargeMonsterCard.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_dArmor] = new PropertyDescriptor ( "dArmor", LargeMonsterCard.class, "getdArmor", "setdArmor" ); // NOI18N
            properties[PROPERTY_dArmor].setDisplayName ( "Armor" );
            properties[PROPERTY_dAttack] = new PropertyDescriptor ( "dAttack", LargeMonsterCard.class, "getdAttack", "setdAttack" ); // NOI18N
            properties[PROPERTY_dAttack].setDisplayName ( "Attack" );
            properties[PROPERTY_dAttackTags] = new PropertyDescriptor ( "dAttackTags", LargeMonsterCard.class, "getdAttackTags", "setdAttackTags" ); // NOI18N
            properties[PROPERTY_dAttackTags].setDisplayName ( "Attack Tags" );
            properties[PROPERTY_dButtonText] = new PropertyDescriptor ( "dButtonText", LargeMonsterCard.class, "getdButtonText", "setdButtonText" ); // NOI18N
            properties[PROPERTY_dButtonText].setDisplayName ( "Button Text" );
            properties[PROPERTY_dHP] = new PropertyDescriptor ( "dHP", LargeMonsterCard.class, "getdHP", "setdHP" ); // NOI18N
            properties[PROPERTY_dHP].setDisplayName ( "HP" );
            properties[PROPERTY_dInstinct] = new PropertyDescriptor ( "dInstinct", LargeMonsterCard.class, "getdInstinct", "setdInstinct" ); // NOI18N
            properties[PROPERTY_dInstinct].setDisplayName ( "Instinct" );
            properties[PROPERTY_dMonsterDescription] = new PropertyDescriptor ( "dMonsterDescription", LargeMonsterCard.class, "getdMonsterDescription", "setdMonsterDescription" ); // NOI18N
            properties[PROPERTY_dMonsterDescription].setDisplayName ( "Description" );
            properties[PROPERTY_dMonsterName] = new PropertyDescriptor ( "dMonsterName", LargeMonsterCard.class, "getdMonsterName", "setdMonsterName" ); // NOI18N
            properties[PROPERTY_dMonsterName].setDisplayName ( "Name" );
            properties[PROPERTY_dMonsterTags] = new PropertyDescriptor ( "dMonsterTags", LargeMonsterCard.class, "getdMonsterTags", "setdMonsterTags" ); // NOI18N
            properties[PROPERTY_dMonsterTags].setDisplayName ( "Monster Tags" );
            properties[PROPERTY_dMoveList] = new PropertyDescriptor ( "dMoveList", LargeMonsterCard.class, "getdMoveList", "setdMoveList" ); // NOI18N
            properties[PROPERTY_dMoveList].setDisplayName ( "Move List" );
            properties[PROPERTY_dQualities] = new PropertyDescriptor ( "dQualities", LargeMonsterCard.class, "getdQualities", "setdQualities" ); // NOI18N
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( LargeMonsterCard.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( LargeMonsterCard.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( LargeMonsterCard.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( LargeMonsterCard.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( LargeMonsterCard.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( LargeMonsterCard.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( LargeMonsterCard.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( LargeMonsterCard.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( LargeMonsterCard.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( LargeMonsterCard.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( LargeMonsterCard.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( LargeMonsterCard.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( LargeMonsterCard.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
